...
public class AssignmentCreateRequestDto {
    ...
    @Schema(example = "1", description = "강의 아이디(선택한 강의가 기타일 경우 null을 넘겨주면 됩니다.)")
    ...
    public static AssignmentCreateRequestDto fromDto(AssignmentUpdateRequestDto requestDto){
        return AssignmentCreateRequestDto.builder()
